...
@Transactional
class MoneyChangingRequestPersistenceAdapter implements IncreaseMoneyPort {
    ...
    public MemberMoney increaseMoney(MembershipId memberId, int increaseMoneyAmount) {
        MemberMoneyJpaEntity entity = memberMoneyRepository.findByMembershipId(Long.parseLong(memberId.getMembershipId()))
            .orElseGet(() -> new MemberMoneyJpaEntity(
